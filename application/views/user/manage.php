							...
							<div class="form-group">
								...
								<div class="col-sm-4">
								   <select class="form-control" name="level" required="required">
									   <option value="1" <?php echo $data->level == "1" ? ' selected' : '';?> >Administrator Pusat</option>
									   <option value="2" <?php echo $data->level == "2" ? ' selected' : '';?> >Anak Perusahaan</option>
									   <option value="3" <?php echo $data->level == "3" ? ' selected' : '';?> >Lainnya</option>									   
									</select>
								</div>
							</div>
						</div>
