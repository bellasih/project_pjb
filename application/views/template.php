  ...
  <body class="hold-transition skin-blue layout-boxed sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
        <!-- Logo -->
        <a href="" class="logo">
          <span class="logo-mini"><b>EXL</b></span>
          <span class="logo-lg"><b>EXCEL APP</b></span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                <li ><a href="<?php echo site_url('pengiriman/rekap')?>"><i class="fa fa-circle-o"></i> Laporan Rekap Data</a></li>
              </ul>
            </li>
			<?php endif; ?>
			<li class="treeview">
